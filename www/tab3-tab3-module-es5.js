...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(storage) {
        ...
        setTimeout(function () {
            _this.storage.get('CorrectAnswers').then(function (val) {
                _this.correctAnswers = val.length;
            });
            _this.storage.get('TotalQuestions').then(function (val1) {
                _this.totalQuestions = val1;
            });
        }, 100);
    }
